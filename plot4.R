...
plot(subdata$Date2,subdata$Global_active_power,type="l",ylab="Global Active Power",xlab="")
plot(subdata$Date2,subdata$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
plot(subdata$Date2,subdata$Global_reactive_power,type="l",xlab="datetime")
#save
dev.off()